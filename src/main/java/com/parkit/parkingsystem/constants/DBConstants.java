...
public class DBConstants {
    ...
    // Requete pour recupérer le nombre total de ticket par voiture
    public static final String GET_NB_TICKET_BY_VEHICULE = "select COUNT(PARKING_NUMBER) from ticket  where VEHICLE_REG_NUMBER=?   ";
