...
public class ParkingService {
	 ...
	 *
	 */
	public boolean checkVehichleRegNumber(String vehichleRegNumber) throws Exception {

		int nbtickets = ticketDAO.getNbTicketsByVehicleRegNumber(vehichleRegNumber);
		if (nbtickets > 1) {
